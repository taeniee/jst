...
import time,random,sys,json,codecs,threading,glob,ast,re
...
ki = JST.LINE()
ki.login(token="Enb6LXls8calVg2TNd32.P7z91sPtM5x5vTp+KWz9eG.Kv5oH/iZ0V0pWK6PIPP7tZ9RRf/DT/oy/GRc7LuKOgA=")
ki.loginResult()
