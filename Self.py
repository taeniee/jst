...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Hadir QQ!!")
#-----------------------------------------------
            elif "inori  say " in msg.text:
					bctxt = msg.text.replace("inori disini shay ","")
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"ada yang lucu")
            elif msg.text in ["bot say"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"Inori􏿿")
					kk.sendText(msg.to,"Miku")
					kc.sendText(msg.to,"Hanami")
            elif msg.text in ["#welcome"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"Selamat datang di grub ini")
					kk.sendText(msg.to,"patuhi rules, langgar ? KICK")
#-----------------------------------------------
            elif msg.text in ["PING","Ping","ping","Samlekom","samlekom"]:
				ki.sendText(msg.to,"Muka kamu􏿿")
				kk.sendText(msg.to,"Imut bangrt")
				kc.sendText(msg.to,"Tapi sayang hatimu busuk􏿿")
#-----------------------------------------------
