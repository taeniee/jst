...
import time, random,sys,ast,re,os,json,subprocess,threading,string,codecs,requests,tweepy,ctypes,urllib,urllib2,wikipedia,tempfile,glob,shutil,unicodedata,goslate
from gtts import gTTS

cl = JST.LINE()
cl.login(token="ErseIplp6KZlUMH2quV6.KIxZ75C7gioBrM9CAgYXzG.T1RGbHrMqlhz70IBhF8iX4qsKdc+5hTNleCDjHeOfz4=")
cl.loginResult()

#ki = JST.LINE()
#ki.login(token="En4fJ4AbLcadHkSHsn02.P7z91sPtM5x5vTp+KWz9eG.RgsB5H1shp1J2gSPe7lpWzoo/ot8CdQyJCM9btk1euk=")
#ki.loginResult()

#ki2 = JST.LINE()
#ki2.login(token="EnBXLEDLVdBmic7SPtY0.dgOEPTvqhsVLUYDLD5n04a.68roA76nBrAys72yTdU/DO+ku/1XQaTiTkIWj7TrQ2E=")
#ki2.loginResult()

#ki3 =JST.LINE()
#ki3.login(token="En8dZFAFZBu6j8pE5MDa.ZtkpH+DhRtV3BYJ71fmmEG.F7+18z4H4+wr5MYG8shl9a4nzc8baRSbF5N19ZIJXdE=")
#ki3.loginResult()

#ki4 = JST.LINE()
#ki4.login(token="EnBpVuyB2kZfrz5xDgbb.hiAf2SzXRil+UQyDCaF/kW.ZWKzebqDelcWIWc+RZrhEk1/Le7a2Qh9oMoQx3ixBbU=")
#ki4.loginResult()

#ki5 = JST.LINE()
#ki5.login(token="EnEPRy5CvrxiWL2Up3Af.yb/UJa2vwZus1dMVvrghxW.kgnTIqklfJ/neEVWg02un5/29JPjPtZlB3xPa3bnBKw=")
#ki5.loginResult()

#ki6 = JST.LINE()
#ki6.login(token="EnEMfmz3li6LKD7EjNh5.psGqLYm9+MM53POk1HTynq.nqqfrUOzJuhSljkDfB6Rw2TTWl//8JmljDyPBx8HhhM=")
#ki6.loginResult()

#ki7 = JST.LINE()
#ki7.login(token="Enx7T1oMa49RowCWDUi7.531oy1+djKnkYMwx0I/CXW.sddle/tQWmkLkIw+AN6OMIjgCv70Bzm7AZbISWBt2WY=")
#ki7.loginResult()

ki7 = ki6 = ki5 = ki4 = ki3 = ki2 = ki = cl
...
Bots=[mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,"u9225f3ef973b18839b466f5c686cb166"]
admin = ["u9225f3ef973b18839b466f5c686cb166"]
staff = ["u9225f3ef973b18839b466f5c686cb166"]
adminMID = "u9225f3ef973b18839b466f5c686cb166"
              ...
              if wait ["detectMention"] == True:
                    ...
                    for mention in mentionees:
                           if mention['M'] in Bots:
                                  ...
                                  break
 #===========================================
            elif msg.text in [".kickall","Mayhem","Nuke","Kick on","Anjing","Bgst","Anj","Me","Kontol","Memek"]:
               if wait["forbidden"] == True:
                    try:
                        cl.sendText(msg.to,"Omongan dijaga yak....")
                     ...
                     if msg.from_ in admin:
                         ...
                         for s in groups.members:
                             if _name in s.displayName:
                                 ...
                                 ki.sendText(msg.to,"Call my Admin to use this command !, \n➡ Unban: " + invite)
                                 break
                             else:
...
#==============Image finish================#
                ...
                if wait["forbidden"] == True: md+=" ❂͜͡☆➣ Rude word: ✔ \n"
                else: md+=" ❂͜͡☆➣ Rude word: ❌ \n"
                ...
                if mimic["status"] == True: md+=" ❂͜͡☆➣ Mimic: ✔ \n"
                else:md+=" ❂͜͡☆➣ Mimic: ❌ \n"
              ...
              if msg.from_ in admin:
                    ...
                    cl.sendText(msg.to, "Read point has been set.\n「Monitor」you can send ♪ check the siders ♪")
                    try:
...
#----------------------------------------------------------
                ...
                ki4.sendText(msg.to,"ٴℬ���ᝨ⟿☬ Ready 􀜁􀆴boss!!!")
...
#============Auto respond=================
#============Auto respond=================
            elif "Rude on" in msg.text:
                wait["forbidden"] = False
                cl.sendText(msg.to,"Rude words has allowed")
                
            elif "Rude off" in msg.text:
                wait["forbidden"] = True
                cl.sendText(msg.to,"Rude words has not allowed")
#============Auto respond=================
#------------------------------------------------------------------	
...
#------------------------------------------------------------------
 #=======================================================
            ...
            elif "T-korean " in msg.text:
              if msg.from_ in admin:
                txt = msg.text.replace("T-korean ","")
                try:
                    gs = goslate.Goslate()
                    trs = gs.translate(txt,'ko')
                    cl.sendText(msg.to,trs)
                    print '[Command] Translate korean'
                except Exception as error:
                    cl.sendText(msg.to,(error))
...
#==========================================================================
                ...
                van = "Has been running for "+waktu(eltime)
                cl.sendText(msg.to,van)

            elif msg.text in ["Reboot"]:
                cl.sendText(msg.to,"Rebooting...")
                restart_program()
                cl.sendText(msg.to,"Reboot success")
                print "@rebooted"
		...
		cl.sendText(msg.to,"Success Removed all chat")
#----------------Mayhem---------------#
	...
	if op.type == 17:
		...
		if wait["blacklist"][op.param2] == True:
		   try:
		    ...
		    random.choice(DEF).sendText(op.param1,"Welcome. Don't Play Bots. I can kick you!")
	    else:
		pass
	if op.type == 19:
	    if op.param2 not in Bots:
