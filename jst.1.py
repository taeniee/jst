...
cl = JST.LINE()
cl.login(token="u601fae8c0d955b3512d439af5511875f:aWF0OiAxNTE0Mjk1NTA0NTQ0Cg==..cAITxyQGIgqSex65/Q3PMKEjpNY=")
cl.loginResult()
...
#ki2 = JST.LINE()
#i2.login(token="EnBXLEDLVdBmic7SPtY0.dgOEPTvqhsVLUYDLD5n04a.68roA76nBrAys72yTdU/DO+ku/1XQaTiTkIWj7TrQ2E=")
#ki2.loginResult()
...
Bots=[mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,"ufcf219802304b297bfbe957d5c300886"]
admin = ["ufcf219802304b297bfbe957d5c300886"]
staff = ["ufcf219802304b297bfbe957d5c300886"]
adminMID = "ufcf219802304b297bfbe957d5c300886"
                     ...
                     if msg.from_ in admin:
                         ...
                         for s in groups.members:
                             if _name in s.displayName:
                                 ...
                                 ki.sendText(msg.to,"Call my Admin to use command !, \n➡ Unban: " + invite)
                                 break
                             else:
