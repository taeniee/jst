...
DEF=[cl,ki,ki2,ki3,ki4,ki5,ki6,ki7]
...
def bot(op):
    try:
        ...
        if op.type == 15:
            random.choice(KAC).sendText(op.param1, "yg tenang di Alam Sana :)")
...
#                if wait["detectMention"] == True: md+=" ❂͜͡☆➣ Auto respon:On\n"
#                else: md+=" ❂͜͡☆➣ Auto respond:off \n"
                ...
                if targets == []:
                    ...
                    for target in targets:
                        try:
                            ...
                            pass
                print "[Command]dp executed"
            elif "Stealgroup" in msg.text or "stealgroup" in msg.text:
