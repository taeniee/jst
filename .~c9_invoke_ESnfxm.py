...
cl = JST.LINE()
cl.login(token="EneLhpDBecczeREUcVS9.e+k3F53WXfjVspleffqcwq.QDaKXeCYPFwwdFLChh8gURwMydzZAnvQMDCr0kJUFv8=")
cl.loginResult()
              ...
              if wait ["detectMention"] == True:
                    ...
                    for mention in mentionees:
                           if mention['M'] in Bots:
                                  ...
                                  break
 #===========================================
            elif msg.text in [".kickall","Mayhem","Nuke","Kick on","Anjing","Bgst","Anj"]:
...
#============Auto respond=================
                ...
                wait["forbidden"] = True
                cl.sendText(msg.to,"Detect Rude words ON")
                
            elif "Rude off" in msg.text:
                wait["forbidden"] = False
                cl.sendText(msg.to,"Detect Rude words OFF")
#============Auto respond=================
#------------------------------------------------------------------	
