...
#==============Image finish================#
              ...
              if msg.from_ in admin:
                    cl.sendText(msg.to, "Cctv mode On..")
                    cl.sendText(msg.to, "An already read point has been set.\n「Monitor」you can send ♪ read point will be created ♪")
                    try:
                        del wait2['readPoint'][msg.to]
                        del wait2['readMember'][msg.to]
                    except:
...
#========================================
              ...
              if msg.from_ in admin:
                    print "[Command]Rebooted"
                    try:
                        cl.sendText(msg.to,"Rebooting...")
                        restart_program()
                        cl.sendText(msg.to, "Succes Rebooted")
                    except:
                        cl.sendText(msg.to,"Please wait")
                        restart_program()
                        cl.sendText(msg.to, "Succes Rebooted")
