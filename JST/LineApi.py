...
class LINE:
  ...
  LA = "WIN10 5.5.3 Windows_OS 10.3.97.7"

  def __init__(self):
    self.Talk = Talk()
    self._session = requests.session()
    self._headers = {'X-Line-Application': '\t1.4.17\tChrome_OS\t1', 'X-Line-Access': 'Ep9YSo0R4bqFylQBmuN9.FZ1GxdwtHYUbcZX6BjXEYq.P7H+MIw6scKJWDLbNJvcLMRE81QEnIPaCkv8s4NHX9A=', 'User-Agent': 'Line/6.0.0 iPad4,1 9.0.2'}
